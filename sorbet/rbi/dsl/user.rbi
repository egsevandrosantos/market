...
class User
  ...
  module GeneratedAttributeMethods
    ...
    def cpf_before_last_save; end

    sig { returns(T.untyped) }
    def cpf_before_type_cast; end

    sig { returns(T::Boolean) }
    def cpf_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def cpf_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def cpf_change_to_be_saved; end

    sig { returns(T::Boolean) }
    def cpf_changed?; end

    sig { returns(T.nilable(::String)) }
    def cpf_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def cpf_previous_change; end

    sig { returns(T::Boolean) }
    def cpf_previously_changed?; end

    sig { returns(T.nilable(::String)) }
    def cpf_previously_was; end

    sig { returns(T.nilable(::String)) }
    def cpf_was; end

    sig { void }
    def cpf_will_change!; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_cpf?; end
